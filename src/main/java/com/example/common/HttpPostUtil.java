...
public class HttpPostUtil {
	...
	public static String httpPost(HttpServletRequest request, String serverURL, String param, String encoding, int so_timeout, int connection_timeout) {
		...
		try{
			...
			httpPost.setHeader("referer","eagleeyes");
	...
	public static String httpPost(String serverURL, String param, String encoding, int so_timeout, int connection_timeout,String sessionId) {
		String strBack = null;
	...
	public static String httpPost(HttpServletRequest request, String serverURL, String param, String encoding) {
		return httpPost(null, serverURL, param, encoding, 5000, 5000);
	}
	...
	public static String httpPost(String serverURL, String param, String encoding,String sessionId) {
		return httpPost(serverURL, param, encoding, 5000, 5000,sessionId);
	}
	...
	public static void main(String[] args) throws Exception
	{
		...
		String serverURL = "http://portal.cdeledu.com/auth/index.php";
		String param = "cmd=ucCheckLogin&type=JSON&jsonpCallback=sfasdf";
		// TODO Auto-generated method stub
		String s = httpPost(serverURL, param, "UTF-8","2EBDF14EFA6A78F9AF4DFB4F582D3D1D");
